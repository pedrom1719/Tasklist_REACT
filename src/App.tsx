...
function App() {
  return (
    <Provider store={store}>
      <main className="flex h-screen w-full items-start justify-start gap-2 sm:fixed sm:top-0 sm:block sm:h-[100%]">
        <header className="relative z-10 hidden w-full bg-violet-500 p-4 sm:flex sm:justify-between">
